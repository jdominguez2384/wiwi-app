...
import { updateUserShift } from "../../../lib/data/shifts";
...
export default function EditShiftPage() {
  ...
  useEffect(() => {
    ...
    setAppName(existingShift.appName);
    setGrossEarnings(String(existingShift.grossEarnings));
    setHoursWorked(String(existingShift.hoursWorked));
    setMilesDriven(String(existingShift.milesDriven));
  }, [existingShift]);
  ...
  async function handleSave() {
    ...
    if (!existingShift) {
      setMessage(
        language === "en" ? "Shift not found." : "No se encontró el turno."
      );
      return;
    }
    ...
    try {
      const { data, error } = await updateUserShift(existingShift.id, {
        shift_date: date,
        app_name: appName,
      ...
      setMessage(
        language === "en" ? "Shift updated successfully." : "Turno actualizado con éxito."
      );
          ...
          <div className="flex justify-between items-start mb-6 gap-4 flex-wrap">
            <div>
              ...
              <h1 className="text-3xl font-semibold mt-1">
                {language === "en" ? "Edit Shift" : "Editar turno"}
              </h1>
            </div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            <p className="text-zinc-600 mb-6">
              {language === "en"
                ...
                : "Actualiza los detalles de tu turno."}
            </p>
